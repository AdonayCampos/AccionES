...
@section('content')
    <div class="container">
        <h1 class="text-center mb-4">Crear Gestión</h1>

        <form action="/gestiones/create" class="mx-auto" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="ges_nombre">Nombre:</label>
                        <input type="text" class="form-control mb-2" id="ges_nombre" name="ges_nombre" required>
                        @error('ges_nombre')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="ges_descripcion" name="ges_descripcion" rows="3"></textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" pattern="[0-9]+" class="form-control mb-2" id="ges_num_benef"
                            name="ges_num_benef" required>
                        @error('ges_num_benef')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control mb-2" id="ges_fecha_inicio" name="ges_fecha_inicio"
                            required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control mb-2" id="ges_fecha_fin" name="ges_fecha_fin" required>
                        @error('ges_fecha_fin')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
