...
@section('content')
    <div class="container">
        ...
        <form action="/empleado/edit/{{ $empleado->per_id }}" class="mx-auto" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <input type="hidden" id="per" name="per" value="{{ $empleado->per_id }}" />
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-2" id="per_primer_nombre" name="per_primer_nombre"
                            required value="{{ $empleado->per_primer_nombre }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-2" id="per_segundo_nombre" name="per_segundo_nombre"
                            value="{{ $empleado->per_segundo_nombre }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-2" id="per_tercer_nombre" name="per_tercer_nombre"
                            value="{{ $empleado->per_tercer_nombre }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-2" id="per_primer_apellido" name="per_primer_apellido"
                            value="{{ $empleado->per_primer_apellido }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-2" id="per_segundo_apellido"
                            value="{{ $empleado->per_segundo_apellido }}" name="per_segundo_apellido">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="tiene_apellido_casada"
                                name="tiene_apellido_casada" {{ $empleado->per_apellido_casado ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-2" id="per_apellido_casado" name="per_apellido_casado"
                            value="{{ $empleado->per_apellido_casado }}"
                            {{ $empleado->per_apellido_casado ? '' : 'disabled' }}>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-2" id="per_dui" name="per_dui"
                            data-inputmask="'mask': '99999999-9'" value="{{ $empleado->per_dui }}" required>
            ...
            <div class="row">
                        ...
                        <select class="form-control mb-2" id="departamento" name="departamento" required>
                            ...
                            @foreach ($dep as $item)
                                <option value="{{ $item->dep_id }}"
                                    {{ $item->dep_id == $empleado->municipio->mun_id_dep ? 'selected' : '' }}>
                                    {{ $item->dep_nombre }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control mb-2" id="per_id_mun_residencia" name="per_id_mun_residencia"
                            required>
                            <option value="">Seleccione un municipio...</option>
                            @foreach ($municipios as $municipio)
                                <option value="{{ $municipio->mun_id }}"
                                    {{ $municipio->mun_id == $empleado->per_id_mun_residencia ? 'selected' : '' }}>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="per_direccion_residencia" name="per_direccion_residencia" rows="3">{{ $empleado->per_direccion_residencia }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control mb-2" id="per_fecha_nacimiento"
                            value="{{ $empleado->per_fecha_nacimiento }}" name="per_fecha_nacimiento"
                            max="{{ date('Y-m-d') }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="per_codigo_emp">Código de Empleado:</label>
                        <input type="text" class="form-control mb-2" id="per_codigo_emp" name="per_codigo_emp"
                            value="{{ $empleado->per_codigo_emp }}" required>
                        @error('per_codigo_emp')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control mb-2" id="per_estado" name="per_estado">
                            <option value="1" {{ $empleado->per_estado == 1 ? 'selected' : '' }}>Activo</option>
                            <option value="0" {{ $empleado->per_estado == 0 ? 'selected' : '' }}>Inactivo</option>
                        </select>
                    </div>
                </div>
            </div>
