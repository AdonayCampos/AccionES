...
@section('content')
    ...
    <div class="container">
        <h1>Reporte de Gestiones por Departamento y Municipios</h1>

        <div class="filter-panel">
            <h2>Filtros</h2>

            <form action="/reportes/gesxmun" method="GET">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <a class="btn btn-success" href="/reportes/gesxmun" class="btn btn-secondary">Limpiar</a>
                        </div>
                    </div>
                </div>
            </form>
        ...
        <div class="row">
            <div class="form-group">
                <a href="/reportes/pdf/gesxmunicipio/{{ base64_encode(json_encode($gestiones)) }}" target="_blank"
